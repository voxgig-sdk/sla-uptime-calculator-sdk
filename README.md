...
This is an unofficial SDK for the SLA Uptime Calculator public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/sla-uptime-calculator` | `npm install @voxgig-sdk/sla-uptime-calculator` |
| Python | `voxgig-sdk-sla-uptime-calculator` | `pip install voxgig-sdk-sla-uptime-calculator` |
| PHP | `voxgig-sdk/sla-uptime-calculator` | `composer require voxgig-sdk/sla-uptime-calculator` |
| Golang | `github.com/voxgig-sdk/sla-uptime-calculator-sdk/go` | `go get github.com/voxgig-sdk/sla-uptime-calculator-sdk/go` |
| Ruby | `voxgig-sdk-sla-uptime-calculator` | `gem install voxgig-sdk-sla-uptime-calculator` |
| Lua | `voxgig-sdk-sla-uptime-calculator` | `luarocks install voxgig-sdk-sla-uptime-calculator` |
...
- Upstream API: [https://uptime.is/about#api](https://uptime.is/about#api)
