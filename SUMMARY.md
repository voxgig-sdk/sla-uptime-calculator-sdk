...
Results: Successful calculation response.
...
- Production server: `https://get.uptime.is`
...
- `sla-uptime-calculator_list`: List records for an entity. No active entity supports this operation.
- `sla-uptime-calculator_load`: Load one record for an entity. Supported entities: `api`.
