...
// SlaUptimeCalculator SDK timeout feature
...
class SlaUptimeCalculatorTimeoutFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _with_timeout(SlaUptimeCalculatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SlaUptimeCalculatorContext $_ctx, float $ms): void
    {
        $client = $this->client;
