...
// SlaUptimeCalculator SDK paging feature
...
class SlaUptimeCalculatorPagingFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _is_list(SlaUptimeCalculatorContext $ctx): bool
    {
