...
// SlaUptimeCalculator SDK audit feature
...
class SlaUptimeCalculatorAuditFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _emit(SlaUptimeCalculatorContext $ctx, string $outcome): void
    {
