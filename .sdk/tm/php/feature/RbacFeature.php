...
// SlaUptimeCalculator SDK rbac feature
...
class SlaUptimeCalculatorRbacFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _required(SlaUptimeCalculatorContext $ctx): ?string
    {
    ...
    private function _reject(SlaUptimeCalculatorContext $ctx, string $required): void
    {
    ...
    private function _track(SlaUptimeCalculatorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
