...
// SlaUptimeCalculator SDK proxy feature
...
class SlaUptimeCalculatorProxyFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    public function init(SlaUptimeCalculatorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SlaUptimeCalculatorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
