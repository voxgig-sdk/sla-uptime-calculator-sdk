...
// SlaUptimeCalculator SDK ratelimit feature
...
class SlaUptimeCalculatorRatelimitFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _acquire(SlaUptimeCalculatorContext $ctx): void
    {
    ...
    private function _track(SlaUptimeCalculatorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
