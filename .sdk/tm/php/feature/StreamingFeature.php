...
// SlaUptimeCalculator SDK streaming feature
...
class SlaUptimeCalculatorStreamingFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _iterate(SlaUptimeCalculatorResult $result): \Generator
    {
    ...
    private function _streamable(SlaUptimeCalculatorContext $ctx): bool
    {
