...
// SlaUptimeCalculator SDK cache feature
...
class SlaUptimeCalculatorCacheFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _through(SlaUptimeCalculatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
