...
// SlaUptimeCalculator SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SlaUptimeCalculatorTestFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    public function init(SlaUptimeCalculatorContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SlaUptimeCalculatorContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = SlaUptimeCalculatorParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SlaUptimeCalculatorContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SlaUptimeCalculatorContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = SlaUptimeCalculatorParam::call($ctx, $k);
