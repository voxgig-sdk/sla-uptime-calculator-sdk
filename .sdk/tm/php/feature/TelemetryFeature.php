...
// SlaUptimeCalculator SDK telemetry feature
...
class SlaUptimeCalculatorTelemetryFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _close(SlaUptimeCalculatorContext $ctx, bool $ok): void
    {
