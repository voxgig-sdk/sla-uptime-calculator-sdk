...
// SlaUptimeCalculator SDK idempotency feature
...
class SlaUptimeCalculatorIdempotencyFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _mutating(SlaUptimeCalculatorContext $ctx): bool
    {
