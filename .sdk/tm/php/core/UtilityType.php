...
// SlaUptimeCalculator SDK utility type

class SlaUptimeCalculatorUtility
{
    ...
    public static function copy(SlaUptimeCalculatorUtility $src): SlaUptimeCalculatorUtility
    {
        $u = new SlaUptimeCalculatorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
