...
// SlaUptimeCalculator SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SlaUptimeCalculatorMakeRequest
{
    public static function call(SlaUptimeCalculatorContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SlaUptimeCalculatorResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SlaUptimeCalculatorResponse($fetched);
        } else {
