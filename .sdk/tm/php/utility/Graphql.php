...
// SlaUptimeCalculator SDK utility: graphql
//
...
class SlaUptimeCalculatorGraphql
{
    ...
    // equivalent.
    public static function body(SlaUptimeCalculatorContext $ctx): mixed
    {
    ...
    public static function errors(SlaUptimeCalculatorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
