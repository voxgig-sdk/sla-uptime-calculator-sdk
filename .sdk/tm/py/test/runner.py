...
class SlaUptimeCalculatorTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SlaUptimeCalculatorTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SlaUptimeCalculatorTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SlaUptimeCalculatorTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
