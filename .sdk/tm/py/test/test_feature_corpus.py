# SlaUptimeCalculator SDK feature corpus test
#
...
def _client(kase):
    ...
    SlaUptimeCalculatorSDK(...), not SlaUptimeCalculatorSDK.test(...): the `test` feature is
    ...
    return SlaUptimeCalculatorSDK(opts)
