...
|---|---|---|
| `ts/` | @voxgig-sdk/sla-uptime-calculator-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/sla-uptime-calculator-sdk \
      --repository voxgig-sdk/sla-uptime-calculator-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/sla-uptime-calculator-sdk` shows it, and
`npm trust revoke @voxgig-sdk/sla-uptime-calculator-sdk --id=<id>` removes it.
