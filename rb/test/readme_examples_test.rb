...
#      offline in seeded test mode (SlaUptimeCalculatorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "SlaUptimeCalculator_sdk.rb")
  SDK_CLASS = "SlaUptimeCalculatorSDK"
  ...
  SDK_BASE = "SlaUptimeCalculator_sdk"
