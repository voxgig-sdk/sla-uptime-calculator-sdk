# SlaUptimeCalculator Ruby SDK



The Ruby SDK for the SlaUptimeCalculator API — an entity-oriented client using idiomatic Ruby conventions.
...
- Releases: [https://github.com/voxgig-sdk/sla-uptime-calculator-sdk/releases](https://github.com/voxgig-sdk/sla-uptime-calculator-sdk/releases)
...
```ruby
client = SlaUptimeCalculatorSDK.test(testopts, sdkopts)
```
...
raise a `SlaUptimeCalculatorError` (a `StandardError` subclass), so wrap
...
```
rb/
├── SlaUptimeCalculator_sdk.rb       -- Main SDK module
...
The main module (`SlaUptimeCalculator_sdk`) exports the SDK class
