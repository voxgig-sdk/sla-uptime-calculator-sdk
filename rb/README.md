...
The Ruby SDK for the SlaUptimeCalculator API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.SlaUptimeCalculator(nil).load(
  { "id" => "test01" }, nil
)
