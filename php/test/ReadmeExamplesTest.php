...
// SlaUptimeCalculator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SlaUptimeCalculatorSDK::test)
...
{
    private const SDK_CLASS = 'SlaUptimeCalculatorSDK';
    ...
    private const SDK_BASE = 'slauptimecalculator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../slauptimecalculator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
