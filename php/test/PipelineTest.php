...
// SlaUptimeCalculator SDK pipeline test
//
...
{
    private static function utility(): SlaUptimeCalculatorUtility
    {
        return new SlaUptimeCalculatorUtility();
    }
    ...
    private static function ctx(array $over = []): SlaUptimeCalculatorContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SlaUptimeCalculatorContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SlaUptimeCalculatorOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SlaUptimeCalculatorError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SlaUptimeCalculatorOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SlaUptimeCalculatorMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SlaUptimeCalculatorOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SlaUptimeCalculatorMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SlaUptimeCalculatorOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SlaUptimeCalculatorMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SlaUptimeCalculatorSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SlaUptimeCalculatorMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SlaUptimeCalculatorResponse([]),
            'result' => new SlaUptimeCalculatorResult([]),
        ]);
        [, $err] = SlaUptimeCalculatorMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SlaUptimeCalculatorSpec([]),
            'response' => null,
            'result' => new SlaUptimeCalculatorResult([]),
        ]);
        [, $err] = SlaUptimeCalculatorMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SlaUptimeCalculatorSpec(['step' => 's']),
            'response' => new SlaUptimeCalculatorResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SlaUptimeCalculatorResult([]),
        ]);
        [, $err] = SlaUptimeCalculatorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SlaUptimeCalculatorSpec(['step' => 's']),
            'response' => new SlaUptimeCalculatorResponse(self::resp(200, ['v' => 1])),
            'result' => new SlaUptimeCalculatorResult([]),
        ]);
        [, $err] = SlaUptimeCalculatorMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SlaUptimeCalculatorSpec(['step' => 's']),
            'response' => new SlaUptimeCalculatorResponse(self::resp(200, ['v' => 2])),
            'result' => new SlaUptimeCalculatorResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SlaUptimeCalculatorMakeResponse::call($ctx);
    ...
    {
        $preset = new SlaUptimeCalculatorResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SlaUptimeCalculatorSpec([]),
            'response' => new SlaUptimeCalculatorResponse([]),
            'result' => new SlaUptimeCalculatorResult([]),
        ...
        [$got, $err] = SlaUptimeCalculatorMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SlaUptimeCalculatorResult([])]);
        [, $err] = SlaUptimeCalculatorMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SlaUptimeCalculatorSpec([]), 'result' => null]);
        [, $err] = SlaUptimeCalculatorMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SlaUptimeCalculatorSpec(['step' => 's']),
            'result' => new SlaUptimeCalculatorResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SlaUptimeCalculatorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SlaUptimeCalculatorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SlaUptimeCalculatorSpec(['step' => 's']),
            'result' => new SlaUptimeCalculatorResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SlaUptimeCalculatorOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SlaUptimeCalculatorMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SlaUptimeCalculatorResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SlaUptimeCalculatorSpec([]),
            'result' => new SlaUptimeCalculatorResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SlaUptimeCalculatorMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SlaUptimeCalculatorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SlaUptimeCalculatorError('boom', 'boom');
        $utility->fetcher = function (SlaUptimeCalculatorContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SlaUptimeCalculatorSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SlaUptimeCalculatorMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SlaUptimeCalculatorContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SlaUptimeCalculatorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SlaUptimeCalculatorResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SlaUptimeCalculatorMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SlaUptimeCalculatorContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SlaUptimeCalculatorSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SlaUptimeCalculatorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SlaUptimeCalculatorResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SlaUptimeCalculatorSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SlaUptimeCalculatorMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SlaUptimeCalculatorMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SlaUptimeCalculatorMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SlaUptimeCalculatorResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SlaUptimeCalculatorDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SlaUptimeCalculatorResult(['ok' => false])]);
        $this->expectException(SlaUptimeCalculatorError::class);
        SlaUptimeCalculatorDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SlaUptimeCalculatorResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SlaUptimeCalculatorMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SlaUptimeCalculatorMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SlaUptimeCalculatorBaseFeature();
        $b = new SlaUptimeCalculatorBaseFeature();
        SlaUptimeCalculatorFeatureAdd::call($ctx, $a);
        SlaUptimeCalculatorFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SlaUptimeCalculatorBaseFeature
    {
        $f = new SlaUptimeCalculatorBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SlaUptimeCalculatorFeatureAdd::call($ctx, self::named_feature('a'));
        SlaUptimeCalculatorFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        SlaUptimeCalculatorFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        SlaUptimeCalculatorFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        SlaUptimeCalculatorFeatureAdd::call($ctx, $replace);
        ...
        SlaUptimeCalculatorFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SlaUptimeCalculatorContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SlaUptimeCalculatorSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SlaUptimeCalculatorPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SlaUptimeCalculatorPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SlaUptimeCalculatorResponse(['headers' => null]),
            'result' => new SlaUptimeCalculatorResult([]),
        ]);
        SlaUptimeCalculatorResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        SlaUptimeCalculatorResultBody::call($ctx);
