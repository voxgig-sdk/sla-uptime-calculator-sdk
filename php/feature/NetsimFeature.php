...
// SlaUptimeCalculator SDK netsim feature
...
class SlaUptimeCalculatorNetsimFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _simulate(SlaUptimeCalculatorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SlaUptimeCalculatorContext $ctx, array $applied): void
    {
        $client = $this->client;
