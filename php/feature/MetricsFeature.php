...
// SlaUptimeCalculator SDK metrics feature
...
class SlaUptimeCalculatorMetricsFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    private function _record(SlaUptimeCalculatorContext $ctx, bool $ok): void
    {
