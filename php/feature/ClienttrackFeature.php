...
// SlaUptimeCalculator SDK clienttrack feature
...
class SlaUptimeCalculatorClienttrackFeature extends SlaUptimeCalculatorBaseFeature
{
    ...
    public function PostConstruct(SlaUptimeCalculatorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SlaUptimeCalculator-SDK';
