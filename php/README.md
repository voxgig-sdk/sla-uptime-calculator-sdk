# SlaUptimeCalculator PHP SDK



The PHP SDK for the SlaUptimeCalculator API — an entity-oriented client using PHP conventions.
...
```
php/
├── slauptimecalculator_sdk.php          -- Main SDK class
...
The main class (`slauptimecalculator_sdk.php`) exports the SDK class
