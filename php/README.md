...
The PHP SDK for the SlaUptimeCalculator API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->SlaUptimeCalculator(null)->load(
    ["id" => "test01"], null
);
