# SlaUptimeCalculator Golang SDK Reference

Complete API reference for the SlaUptimeCalculator Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *SlaUptimeCalculatorSDK`
...
#### `Api(data map[string]any) SlaUptimeCalculatorEntity`
