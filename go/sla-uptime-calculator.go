...
// instead of `sdk.NewSlaUptimeCalculatorSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *SlaUptimeCalculatorSDK  { return NewSlaUptimeCalculatorSDK(nil) }
func Test() *SlaUptimeCalculatorSDK { return TestSDK(nil, nil) }
