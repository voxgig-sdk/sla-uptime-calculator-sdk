...
(0, node_test_1.describe)('ApiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SlaUptimeCalculatorSDK({
...
function liveScenariosActive() { return false && process.env.SLA_UPTIME_CALCULATOR_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SlaUptimeCalculatorSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SLA_UPTIME_CALCULATOR_TEST_API_ENTID'];
    ...
    const client = new __1.SlaUptimeCalculatorSDK({
        base: 'http://localhost:8080',
