...
| `tester(testopts?, sdkopts?)` | `SlaUptimeCalculatorSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `SlaUptimeCalculatorSDK.test(testopts?, sdkopts?)` | `SlaUptimeCalculatorSDK` | Create a test-mode client. |
...
| `client` | `client(): SlaUptimeCalculatorSDK` | Return the parent SDK client. |
...
├── src/
│   ├── SlaUptimeCalculatorSDK.ts        # Main SDK class
