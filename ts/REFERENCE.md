# SlaUptimeCalculator TypeScript SDK Reference

Complete API reference for the SlaUptimeCalculator TypeScript SDK.
...
```ts
new SlaUptimeCalculatorSDK(options?: object)
```
...
#### `SlaUptimeCalculatorSDK.test(testopts?, sdkopts?)`
...
**Returns:** `SlaUptimeCalculatorSDK` instance in test mode.
...
Alias for `SlaUptimeCalculatorSDK.test()`.
...
Return the parent `SlaUptimeCalculatorSDK` instance.
