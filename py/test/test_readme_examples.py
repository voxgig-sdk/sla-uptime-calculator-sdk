# SlaUptimeCalculator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SlaUptimeCalculatorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SlaUptimeCalculatorSDK(...) and SlaUptimeCalculatorSDK.test(...) become
#      SlaUptimeCalculatorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "slauptimecalculator_sdk"
_SDK_CLASS = "SlaUptimeCalculatorSDK"
