# SlaUptimeCalculator Python SDK



The Python SDK for the SlaUptimeCalculator API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/sla-uptime-calculator-sdk/releases)) or
...
```
py/
├── slauptimecalculator_sdk.py         -- Main SDK module
