...
from slauptimecalculator_sdk.utility import register

# Load features
from slauptimecalculator_sdk.feature.base_feature import SlaUptimeCalculatorBaseFeature
from slauptimecalculator_sdk.features import _has_feature, _make_feature
...
class SlaUptimeCalculatorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = SlaUptimeCalculatorUtility()
        self._utility = utility

        from slauptimecalculator_sdk.config import shared_config
    ...
    def get_utility(self):
        return SlaUptimeCalculatorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SlaUptimeCalculatorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Api(self, data=None) -> "ApiEntity":
        ...
        from slauptimecalculator_sdk.entity.api_entity import ApiEntity
        return ApiEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "SlaUptimeCalculatorSDK":
        if sdkopts is None:
            sdkopts = {}
