...
func registerTools(server *mcp.Server, client *sdk.SlaUptimeCalculatorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "sla-uptime-calculator_list",
		Description: "List records from SlaUptimeCalculator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "sla-uptime-calculator_load",
		Description: "Load a single record from SlaUptimeCalculator. " +
...
func runOp(client *sdk.SlaUptimeCalculatorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SlaUptimeCalculatorSDK, name string) (sdk.SlaUptimeCalculatorEntity, error) {
