// Command SlaUptimeCalculator-mcp is an MCP server exposing the SlaUptimeCalculator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SlaUptimeCalculator_list  — list records of an entity
//	SlaUptimeCalculator_load  — load a single record of an entity
//
