...
function runner.env_override(m)
  local live = runner.getenv("SLAUPTIMECALCULATOR_TEST_LIVE")
  local override = runner.getenv("SLAUPTIMECALCULATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SLAUPTIMECALCULATOR_TEST_EXPLAIN")
