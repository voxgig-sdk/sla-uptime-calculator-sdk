...
function runner.env_override(m)
  local live = runner.getenv("SLA_UPTIME_CALCULATOR_TEST_LIVE")
  local override = runner.getenv("SLA_UPTIME_CALCULATOR_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SLA_UPTIME_CALCULATOR_TEST_EXPLAIN")
