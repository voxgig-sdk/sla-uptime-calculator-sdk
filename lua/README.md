# SlaUptimeCalculator Lua SDK



The Lua SDK for the SlaUptimeCalculator API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/sla-uptime-calculator-sdk/releases)),
...
```
lua/
├── sla-uptime-calculator_sdk.lua    -- Main SDK module
...
The main module (`sla-uptime-calculator_sdk`) exports the SDK constructor
