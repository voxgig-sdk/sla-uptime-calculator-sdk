...
func registerSDKWords(r *eng.Registry, client *sdk.SlaUptimeCalculatorSDK) {
...
func runOp(client *sdk.SlaUptimeCalculatorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
