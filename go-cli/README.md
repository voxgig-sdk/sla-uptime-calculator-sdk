...
AQL-driven CLI and REPL for the SlaUptimeCalculator SDK. Positional arguments are
...
```sh
go build -o sla-uptime-calculator-cli ./...
```
...
./sla-uptime-calculator-cli list api
./sla-uptime-calculator-cli load 1 api
./sla-uptime-calculator-cli load '{id:1}' api
